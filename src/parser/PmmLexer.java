...
public class PmmLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__33", "T__34", "T__35", "TRASH", "COMENTARIO", "ID", "INT_CONSTANT", 
			"REAL_CONSTANT", "CHAR_CONSTANT", "LETRA", "DIGITO", "REAL_CONSTANT_P", 
			"REAL_CONSTANT_E", "COMENTARIO_1LINEA", "COMENTARIO_NLINEAS"
		};
	}
